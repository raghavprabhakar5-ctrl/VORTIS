...
.bubble-ai{font-size:15px;color:var(--text1);line-height:1.75;max-width:94%;font-family:var(--font-main);-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}
...
.md-content p{margin-bottom:6px;color:var(--text1);line-height:1.7;font-size:15px;font-family:var(--font-main)}
    ...
    <div ref={contentRef} className="md-content">
     ...
     rehypePlugins={[rehypeKatex]}
        ...
        components={{
         ...
         p: ({children}) => <p style={{ margin: '0 0 8px', color: 'var(--text1)', lineHeight: 1.8, fontSize: 15 }}>{children}</p>,
