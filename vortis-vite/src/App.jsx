    <path d="M0 0 C14.1875 8.8125 30.125 18.25 48.625 29.25 C69.9375 41.9375 95.09496436 57.0626947 145.82397461 86.61987305 C185.99103737 110.09007588 206.0078125 121.9375 234.9375 138.9375 C266.24169922 157.34179688 297.48046875 175.8203125 339.0078125 200.23291016 C365.9375 215.9375 389.86283875 229.9574585 400.5546875 236.19140625 C416.60946345 245.55018456 444.9375 268.9375 C457.8147078 280.12667225 472.9375 297.9375 C502.10135822 335.75667549 526.76171875 429.16796875 C528.1875 455.75 C528.14936701 486.46728486 514.9375 541.9375 C505.328125 566.25 C493.19095427 592.77849538 466.9375 627.9375 C446.91051639 650.78227524 435.59521484 659.63916016 C412.69556467 676.99358101 401.9375 682.9375 C362.4058611 702.53046473 342.125 707.875 C322.23558396 712.85802357 288.44677734 714.32861328 C262.42118835 714.36701497 229.5625 708.25 C205.25404578 701.06934237 194.9375 696.9375 C153.77833323 676.80454295 135.9375 664.9375 C113.35253906 644.75219727 C116.1953125 634.63671875 C132.5625 623.25 C157.6875 608.5 C186.7109375 590.71484375 C215.375 581.203125 C224.9296875 585.5078125 C239.9375 591.9375 C267.37641725 602.39949361 310.9375 599.9375 C337.86656461 591.49492449 375.54150391 564.31445312 C397.17243769 543.92679318 415.49951172 495.02197266 C420.12280273 458.72802734 C420.16210938 452.66015625 C409.9375 402.9375 C393.83049784 366.38307152 337.41015625 327.01171875 C301.875 306.1875 C251.5 276.6875 C205.88555908 249.87939453 C144.65869141 213.56640625 C82.93652344 176.73925781 C43.11157227 152.74481201 C6.21069336 130.62011719 C-14.89790344 118.03100586 C-32.39320143 107.7648254 -45.0625 92.9375 C-48.22363281 80.31396484 C-48.30273438 57.29833984 C-48.36070633 44.90184593 C-48.38607025 35.3273201 C-48.51191211 18.13832571 -47.57700252 9.45700747 -38.58203125 0.11328125 C-27.3136669 -9.61769385 -11.83914377 -7.57133779 0 0 Z" fill={color} transform="translate(587.0625,330.0625)"/>
  </svg>
);
...
.uc-btn{width:100%;padding:7px;background:linear-gradient(135deg,var(--indigo),var(--violet));border:none;border-radius:8px;color:white;font-size:12px;font-weight:700;cursor:pointer;font-family:'Geist',sans-serif;transition:all .2s;letter-spacing:.03em}
...
.ia-btn{display:flex;align-items:center;gap:5px;padding:5px 10px;background:var(--bg3);border:1px solid var(--border);border-radius:8px;color:var(--text3);font-size:12px;cursor:pointer;font-family:'Geist',sans-serif;transition:all .15s;white-space:nowrap;-webkit-tap-highlight-color:transparent}
...
.btn-primary{background:linear-gradient(135deg,var(--indigo),var(--violet));border:none;color:white;padding:9px 18px;border-radius:10px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Geist',sans-serif;transition:all .2s;display:flex;align-items:center;gap:6px;-webkit-tap-highlight-color:transparent}
.btn-primary:hover{transform:translateY(-1px);box-shadow:0 6px 20px rgba(99,102,241,.4)}
.btn-primary:disabled{opacity:.4;cursor:not-allowed;transform:none;box-shadow:none}
.btn-ghost{background:transparent;border:1px solid var(--border2);color:var(--text2);padding:8px 16px;border-radius:10px;font-size:13px;font-weight:500;cursor:pointer;font-family:'Geist',sans-serif;transition:all .15s;display:flex;align-items:center;gap:6px}
.btn-ghost:hover{background:var(--bg3);color:var(--text1)}
.btn-danger{background:transparent;border:1px solid rgba(239,68,68,.3);color:#ef4444;padding:8px 16px;border-radius:10px;font-size:13px;font-weight:500;cursor:pointer;font-family:'Geist',sans-serif;transition:all .15s;display:flex;align-items:center;gap:6px}
...
export default function VortisAI() {
  ...
  // ── handleLogin: Google + GitHub + Apple ──
  const handleLogin = async (provider) => {
    ...
    try {
      ...
      else if (provider === 'apple') authProvider = new OAuthProvider('apple.com');
      ...
      if (!displayName || displayName.trim() === '') {
        if (provider === 'github') {
          ...
          const raw = tokenResp?.screenName || tokenResp?.displayName || u.email?.split('@')[0] || 'User';
          displayName = raw.replace(/[_-]/g, ' ').replace(/\d+$/g, '').trim().split(' ').filter(Boolean).map(w => w.charAt(0).toUpperCase() + w.slice(1).toLowerCase()).join(' ') || 'User';
        } else {
          displayName = u.email?.split('@')[0] || 'User';
        }
        try { await updateProfile(u, { displayName }); } catch(_) {}
      } else if (provider === 'github') {
        const looksLikeUsername = /^[a-z0-9_-]+$/i.test(displayName) && !/\s/.test(displayName);
        if (looksLikeUsername) {
          displayName = displayName.replace(/[_-]/g, ' ').replace(/\d+$/g, '').trim().split(' ').filter(Boolean).map(w => w.charAt(0).toUpperCase() + w.slice(1).toLowerCase()).join(' ') || displayName;
          try { await updateProfile(u, { displayName }); } catch(_) {}
        }
      }
  ...
  return (
    <div className="v-app">
      ...
      <div className="main">
          ...
          <div className="chat-inner">
            ...
            {isStreaming && streamText && (
              <div className="msg-wrap" style={{ display: 'flex', gap: 12, marginBottom: 18 }}>
                <VortisAvatar size={28} animating/>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 5 }}><span className="ai-name">VORTIS</span><span style={{ fontSize: 10.5, color: 'var(--cyan)', fontFamily: 'JetBrains Mono' }}>typing…</span></div>
                  <div className="bubble-ai"><MsgContent text={streamText}/><span className="cursor-blink"/></div>
                </div>
              </div>
            )}
            <div ref={bottomRef}/>
          ...
          <div className="input-inner">
            {(uploadedDoc || imgGenMode || researchMode) && (
              <div className="attach-chips">
                {uploadedDoc && <div className="attach-chip doc"><FileText size={10}/><span style={{ maxWidth: 120, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{uploadedDoc.name}</span><button onClick={() => { setUploadedDoc(null); convHistory.current = []; }}><X size={10}/></button></div>}
                {imgGenMode && <div className="attach-chip img"><ImageIcon size={10}/><span>Image Gen</span><select value={imgGenStyle} onChange={e => setImgGenStyle(e.target.value)} style={{ background: 'var(--bg2)', border: 'none', color: 'var(--indigo)', fontSize: 11, fontFamily: 'JetBrains Mono', cursor: 'pointer', outline: 'none', marginLeft: 3 }}>{IMG_STYLES.map(s => <option key={s} value={s} style={{ background: 'var(--bg2)', color: 'var(--text1)' }}>{s}</option>)}</select><button onClick={() => { setImgGenMode(false); setInput(''); }}><X size={10}/></button></div>}
                {researchMode && <div className="attach-chip mode"><Search size={10}/><span>Deep Research</span><button onClick={() => setResearchMode(null)}><X size={10}/></button></div>}
              </div>
            )}
            {showMenu && (
              <div className="menu-popup">
                {menuItems.map((item, i) => (
                  <button key={i} className="menu-item" onClick={item.fn} style={{ borderBottom: i < menuItems.length-1 ? '1px solid var(--border)' : 'none', background: item.active ? 'rgba(99,102,241,.05)' : 'transparent' }}>
                    ...
                    <div style={{ flex: 1 }}><p style={{ color: 'var(--text1)', fontSize: 13, fontWeight: 500, margin: '0 0 1px' }}>{item.label}</p><p style={{ color: 'var(--text3)', fontSize: 11.5, margin: 0, fontFamily: 'JetBrains Mono' }}>{item.sub}</p></div>
            ...
            <div className="input-box">
              {pendingCode && (
                <div style={{ padding: '10px 14px 6px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 12px', background: 'rgba(99,102,241,.07)', border: '1px solid rgba(99,102,241,.25)', borderRadius: 10 }}>
                    <div style={{ width: 32, height: 32, borderRadius: 8, background: 'rgba(99,102,241,.15)', border: '1px solid rgba(99,102,241,.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><FileText size={14} color="var(--indigo)"/></div>
                    <div style={{ flex: 1, minWidth: 0 }}><div style={{ fontSize: 12, fontWeight: 600, color: 'var(--text1)', marginBottom: 2 }}>Code snippet</div><div style={{ fontSize: 10.5, color: 'var(--indigo)', fontFamily: 'JetBrains Mono' }}>{pendingCode.lines} lines · ready</div></div>
              ...
              <textarea ref={textareaRef} value={input} onChange={e => { setInput(e.target.value); autoResize(e); }}
                onPaste={e => { const text = e.clipboardData.getData('text'); const isCode = text.split('\n').length > 4 || /[{};=>]/.test(text); if (isCode && text.length > 100) { e.preventDefault(); setPendingCode({ content: text, lines: text.split('\n').length }); } }}
                onKeyDown={onKey} disabled={isProcessing}
                placeholder={imgGenMode ? `Describe the image… (${imgGenStyle})` : researchMode === 'deep' ? 'What should I research in depth?' : pendingImage ? 'Ask something about this image…' : 'Message Vortis…'}
                rows={1} className="input-field"
              />
              <div className="input-actions-row">
                <button className={`ia-btn ${showMenu ? 'active' : ''}`} onClick={() => setShowMenu(!showMenu)}><Plus size={13}/><span>Add</span></button>
                <div className="ia-right">
                  ...
                  <button className={`mic-btn ${isListening ? 'listening' : ''}`} onClick={() => { if (isListening) { recogRef.current?.stop(); setIsListening(false); } else if (recogRef.current) { setIsListening(true); recogRef.current.start(); } }} disabled={isProcessing && !isListening}>
                    {isListening ? <MicOff size={13}/> : <Mic size={13}/>}
                  </button>
                  <button className="send-btn" onClick={handleSend} disabled={isProcessing}>{isProcessing ? <Loader size={14} style={{ animation: 'spin 1s linear infinite' }}/> : <ArrowUp size={14}/>}</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="disclaimer">{tier === 'free' ? `${messagesLeft} messages left today · Resets at midnight` : `${tier.toUpperCase()} plan · Ctrl+K = new chat`}</div>
      </div>

      {showSettings && <SettingsModal profile={profile} tier={tier} usage={usage} LIMITS={LIMITS} autoSpeak={autoSpeak} setAutoSpeak={setAutoSpeak} isDark={isDark} setIsDark={setIsDark} handleLogout={handleLogout} setShowUpgrade={setShowUpgrade} onClearAll={handleClearAllData} memories={memories} onDeleteMemory={deleteMemory} onClearMemories={clearMemories} setConfirmDialog={setConfirmDialog} onClose={() => setShowSettings(false)}/>}
            ...
            <div className="modal-box" style={{ maxWidth: 820, width: '100%' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20, flexWrap: 'wrap', gap: 10 }}>
                <div>
                  ...
                  {availablePlans.length === 0 ? <p style={{ fontSize: 12, color: 'var(--green)', fontFamily: 'JetBrains Mono' }}>✓ You're on the highest plan — Platinum</p> : <p style={{ fontSize: 12, color: 'var(--text3)', fontFamily: 'JetBrains Mono' }}>All plans renew automatically · Cancel anytime · Upgrade only</p>}
                </div>
                  ...
                  {availablePlans.map(plan => (
                    <div key={plan.tier} className={`plan-card ${plan.popular ? 'featured' : ''}`} style={{ position: 'relative' }}>
                      ...
                      <div style={{ textAlign: 'center', marginBottom: 16 }}>
                        ...
                        <div style={{ display: 'flex', gap: 4, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 12 }}>{plan.durations.map((d, i) => <button key={i} onClick={() => setSelectedDuration(i)} style={{ padding: '3px 8px', borderRadius: 8, fontSize: 10.5, fontFamily: 'JetBrains Mono', cursor: 'pointer', border: `1px solid ${selectedDuration===i?'var(--indigo)':'var(--border2)'}`, background: selectedDuration===i?'rgba(99,102,241,.12)':'var(--bg3)', color: selectedDuration===i?'var(--indigo)':'var(--text3)', transition: 'all .15s' }}>{d.label}</button>)}</div>
                        ...
                        {plan.durations[selectedDuration].saving && <span style={{ fontSize: 10.5, background: 'rgba(16,185,129,.1)', color: 'var(--green)', border: '1px solid rgba(16,185,129,.2)', borderRadius: 20, padding: '2px 8px', fontFamily: 'JetBrains Mono', display: 'inline-block', marginTop: 4 }}>{plan.durations[selectedDuration].saving}</span>}
                      </div>
                      <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 16px' }}>{plan.feats.map((f, i) => <li key={i} style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '5px 0', fontSize: 12.5, color: 'var(--text2)', borderBottom: '1px solid var(--border)' }}><Check size={11} color="var(--green)"/>{f}</li>)}</ul>
                      <button onClick={() => { setSelectedPlan({ ...plan, ...plan.durations[selectedDuration] }); setShowUpgrade(false); setShowPayment(true); }} className="btn-primary" style={{ width: '100%', justifyContent: 'center', padding: '10px', fontSize: 13, fontWeight: 700, borderRadius: 10 }}>Upgrade to {plan.name}</button>
                    </div>
                  ))}
                </div>
              )}
        ...
        <div className="modal-overlay">
          <div className="modal-box" style={{ maxWidth: 380 }}>
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 14 }}>
              {['card','upi'].map(m => <button key={m} onClick={() => setPayMethod(m)} style={{ flex: 1, padding: '9px', borderRadius: 10, background: payMethod===m?'rgba(99,102,241,.12)':'var(--bg3)', border: `1px solid ${payMethod===m?'var(--indigo)':'var(--border2)'}`, color: payMethod===m?'var(--indigo)':'var(--text2)', cursor: 'pointer', fontFamily: 'Geist', fontWeight: 600, fontSize: 12.5, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, transition: 'all .15s' }}>{m === 'card' ? <><CreditCard size={13}/>Card</> : <><Wifi size={13}/>UPI</>}</button>)}
            </div>
            {payMethod === 'card' && <div style={{ marginBottom: 12 }}><input placeholder="Card number" value={cardNum} onChange={e => setCardNum(formatCard(e.target.value))} className="pay-input" style={{ marginBottom: 8 }}/><div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}><input placeholder="MM/YY" value={cardExp} onChange={e => setCardExp(formatExp(e.target.value))} className="pay-input"/><input placeholder="CVV" value={cardCvv} onChange={e => setCardCvv(e.target.value.replace(/\D/g,'').slice(0,3))} className="pay-input"/></div></div>}
            {payMethod === 'upi' && <div style={{ marginBottom: 12 }}><input placeholder="UPI ID (name@upi)" value={upiId} onChange={e => setUpiId(e.target.value)} className="pay-input"/><p style={{ fontSize: 11, color: 'var(--text3)', textAlign: 'center', marginTop: 5 }}>GPay · PhonePe · Paytm</p></div>}
            <button onClick={processPayment} disabled={isUpgrading} className="btn-primary" style={{ width: '100%', justifyContent: 'center', padding: '12px', borderRadius: 11, fontSize: 14, fontWeight: 700 }}>{isUpgrading ? <><Loader size={14} style={{ animation: 'spin 1s linear infinite' }}/>Processing…</> : <><Crown size={14}/>Pay {selectedPlan?.price}</>}</button>
            ...
            {feedbackDone ? (
              ...
              <>
                ...
                <div style={{ display: 'flex', gap: 5, marginBottom: 14, flexWrap: 'wrap' }}>
                  {['general','bug','feature','compliment'].map(t => <button key={t} onClick={() => setFeedbackType(t)} style={{ padding: '5px 11px', borderRadius: 20, border: `1px solid ${feedbackType===t?'var(--indigo)':'var(--border2)'}`, background: feedbackType===t?'rgba(99,102,241,.08)':'var(--bg3)', color: feedbackType===t?'var(--indigo)':'var(--text3)', fontSize: 12, cursor: 'pointer', fontFamily: 'Geist', transition: 'all .12s', textTransform: 'capitalize' }}>{t}</button>)}
                </div>
                <div style={{ marginBottom: 13 }}>
                  <p style={{ fontSize: 12.5, color: 'var(--text2)', marginBottom: 7 }}>How would you rate VORTIS?</p>
                  <div style={{ display: 'flex', gap: 6 }}>{[1,2,3,4,5].map(n => <button key={n} onClick={() => setFeedbackRating(n)} style={{ width: 38, height: 38, borderRadius: 10, border: `1px solid ${feedbackRating>=n?'var(--amber)':'var(--border2)'}`, background: feedbackRating>=n?'rgba(245,158,11,.1)':'var(--bg3)', cursor: 'pointer', fontSize: 18, transition: 'all .15s', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>★</button>)}</div>
                </div>
                <div style={{ marginBottom: 14 }}>
                  <p style={{ fontSize: 12.5, color: 'var(--text2)', marginBottom: 7 }}>Tell us more</p>
                  <textarea className="feedback-textarea" value={feedbackText} onChange={e => setFeedbackText(e.target.value)} placeholder="What could be better, or what do you love?" rows={4}/>
                </div>
                <button onClick={submitFeedback} disabled={feedbackSending||!feedbackRating||!feedbackText.trim()} className="btn-primary" style={{ width: '100%', justifyContent: 'center', padding: '11px', borderRadius: 11, fontSize: 13.5, fontWeight: 700 }}>{feedbackSending ? <><Loader size={14} style={{ animation: 'spin 1s linear infinite' }}/> Sending…</> : <>Send Feedback</>}</button>
              </>
            )}
          </div>
        </div>
      ...
      {toast && (
        <div style={{ position: 'fixed', bottom: 28, left: 0, right: 0, zIndex: 9999, display: 'flex', justifyContent: 'center', pointerEvents: 'none' }}>
          <div style={{ background: 'var(--bg2)', border: `1px solid ${toast.color}`, color: toast.color, padding: '11px 24px', borderRadius: 12, fontSize: 13.5, fontWeight: 600, fontFamily: 'JetBrains Mono', boxShadow: '0 8px 32px rgba(0,0,0,.5)', whiteSpace: 'nowrap', display: 'flex', alignItems: 'center', gap: 8, animation: 'fadeUp .2s ease' }}>{toast.msg}</div>
        </div>
      )}
      <Analytics />
    </div>
