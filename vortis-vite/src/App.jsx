...
.bubble-user{background:linear-gradient(135deg,#4f46e5,#6366f1);border-radius:18px 18px 4px 18px;padding:10px 15px;font-size:13px;color:#e0e7ff;line-height:1.6;max-width:100%;box-shadow:0 4px 16px rgba(99,102,241,.25);word-break:break-word;overflow-wrap:anywhere;white-space:pre-wrap;font-family:'Source Serif 4',Georgia,serif}
.bubble-ai{font-size:13px;color:var(--text1);line-height:1.8;max-width:94%;font-family:'Source Serif 4',Georgia,serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}
...
.md-content p{margin-bottom:6px;color:var(--text1);line-height:1.6;font-size:13px;font-family:'Source Serif 4',Georgia,serif}
